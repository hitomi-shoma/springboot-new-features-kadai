...
-- reviewテーブル
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (1, 1, 1, 5, '素晴らしい宿でした。また利用したいです。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (2, 2, 1, 4, '駅から近く、プライベートな空間を確保できました。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (3, 3, 1, 4, 'お部屋もきれいで朝食も付いてとてもよかったです。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (4, 4, 1, 5, '従業員の方々は優しく、旅館のようなゆったりとした時間でした。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (5, 5, 1, 4, 'しっかり清掃されていて清潔でした。また利用したいです。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (6, 6, 1, 3, '自分はとても気に入ったので、家族にも紹介しました。ぜひまた利用したいです。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (7, 7, 1, 4, '2度目の利用ですが、最高のパフォーマンスのあるホテルです。');
INSERT IGNORE INTO review (id, user_id, house_id, score, review_text) VALUES (8, 8, 1, 4, 'アットホームなお宿を希望される方にはおすすめできます。');
